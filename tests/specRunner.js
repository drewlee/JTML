describe('JHTML parser', function(){
	...
	it('should output multiple self closing tags correctly', function(){
		...
		expect(parseJTML(tag)).toEqual('<hr /><input type="text" /><br /><link rel="stylesheet" href="css/styles.css" />');
	});
